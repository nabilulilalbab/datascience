...
Industri telekomunikasi merupakan salah satu sektor utama di negara-negara berkembang. Kemajuan teknologi dan meningkatnya jumlah operator telah meningkatkan tingkat persaingan di pasar (Ahmad et al., 2019). Perusahaan telekomunikasi menghadapi tantangan besar dalam mempertahankan pelanggan (*customer retention*) karena biaya untuk mendapatkan pelanggan baru jauh lebih tinggi dibandingkan dengan mempertahankan pelanggan yang sudah ada. Penelitian menunjukkan bahwa biaya akuisisi pelanggan baru dapat mencapai enam kali lebih tinggi daripada biaya retensi pelanggan (Ahmad et al., 2019).

*Customer churn* (perpindahan pelanggan dari satu provider ke provider lain) menjadi masalah kritis yang berdampak langsung pada pendapatan perusahaan. Perusahaan perlu mengidentifikasi faktor-faktor yang menyebabkan pelanggan churn dan mengambil tindakan preventif untuk mengurangi tingkat churn.
...
Berdasarkan Vanlalhriati dan Singh (2015), statistik deskriptif berfokus pada merangkum dan menggambarkan karakteristik dari sekumpulan data. Dalam konteks churn prediction, kita menggunakan:
...
NumPy (Numerical Python) adalah library fundamental untuk komputasi numerik di Python (McKinney, 2012). Library ini menyediakan struktur data array multidimensi yang efisien.
...
Pandas adalah library untuk manipulasi dan analisis data yang powerful (McKinney, 2012). Library ini menyediakan struktur data DataFrame yang memudahkan pengolahan data tabel.
...
3. **Statistical Foundation**: Konsep statistik deskriptif seperti ukuran pemusatan (mean, median), ukuran penyebaran (variance, standard deviation, IQR), dan ukuran asimetri (skewness, kurtosis) menjadi dasar dalam memahami pola data pelanggan (Vanlalhriati & Singh, 2015).

4. **Python Implementation**: NumPy menyediakan struktur array multidimensi dan operasi matematis efisien, sementara Pandas menawarkan manipulasi data tabular yang powerful (McKinney, 2012).
...
Sapre, A., & Vartak, S. (2020). Scientific computing and data analysis using NumPy and Pandas. *International Research Journal of Engineering and Technology (IRJET)*, *7*(12), 236-240. https://www.irjet.net/archives/V7/I12/IRJET-V7I12236.pdf

Vanlalhriati, C., & Singh, E. N. (2015). Descriptive statistics in business research. *International Journal of Advanced Research*, *3*(6), 1409-1415. https://www.researchgate.net/publication/390231376_DESCRIPTIVE_STATISTICS_IN_BUSINESS_RESEARCH

---

*Dokumen ini dibuat sebagai referensi untuk analisis penerapan metode Data Science dengan basis jurnal ilmiah.*
